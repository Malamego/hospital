...
class UsersDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        ...
        ->addColumn('type', function ($model) {
            if ($model->type == 'admin') {
                ...
                return '
                    <span style="padding: 1px 6px;" class="label lable-sm label-info">' . trans("main.doctor") . '</span>
                ';
            }
            else if ($model->type == 'nurse'){
                return '
                    <span style="padding: 1px 6px;" class="label lable-sm label-warning">' . trans("main.nurse") . '</span>
                ';
            }
            else {
                return '
                    <span style="padding: 1px 6px;" class="label lable-sm label-danger">' . trans("main.user") . '</span>
                ';
            }
        })
    ...
    {
        $query = User::query()->with('dep_relation')->select('users.*');
