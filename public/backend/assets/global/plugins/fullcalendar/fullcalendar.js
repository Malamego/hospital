...
// If the dates are the same as far as the format string is concened, just return a single
...
// formatting chunk is concened, format date1 against `chunk`. Otherwise, return `false`.
