    ...
    <div class="form-group{{ $errors->has('type') ? ' has-error' : '' }}">
        ...
        <div class="col-md-10">
            <select class="form-control" id="type" name="type">
                ...
                <option value="doctor" {{ getData($data, 'type') == 'doctor' ? ' selected' : '' }}>{{trans('main.doctor')}}</option>
                <option value="nurse" {{ getData($data, 'type') == 'nurse' ? ' selected' : '' }}>{{trans('main.nurse')}}</option>
                <!-- <option value="admin" {{ getData($data, 'type') == 'admin' ? ' selected' : '' }}>{{trans('main.admin')}}</option> -->
            </select>
            @if ($errors->has('type'))
                <span class="help-block">
